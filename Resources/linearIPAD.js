...
winLinearIPAD.add(advancedButtonA);
			...
			//Labels
				...
				top:195
					...
					winLinearIPAD.add(labelYesBeforeEarlier);
					winLinearIPAD.add(labelNoBeforeEarlier);
