...
static NSString * const kTitanium_WhatisTheOrderJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_titanium_whatistheorderInjection
{
	...
	[html appendString:kTitanium_WhatisTheOrderJavascript];
...
{
	// attempt to make well-formed HTML and inject in our Titanium_WhatisTheOrder bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _titanium_whatistheorderInjection]];
